...
This site is a personal professional landing page for Ethan Hetzler, a University of Iowa student entering the financial advising field. It is designed for young professionals in the Kansas City area who want to understand Ethan’s background, values, and experience and have an easy way to contact him. A successful outcome is a clean one-page site that builds trust, presents Ethan professionally, and helps generate new business leads.
---
